...
<div class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<div class="product-quantity">
		<?php 
			...
			echo apply_filters( 'woocommerce_order_item_quantity_html', ' <span class="product-quantity">' . $qty_display . ' шт</span>', $item ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
