...
// if( !$termChildren && $idFilter ) {
// 	echo do_shortcode('[searchandfilter id="' . $idFilter . '"]');
// }

//echo do_shortcode('[searchandfilter id="238"]'); 
...
//echo do_shortcode('[products category="elektrotehnicheskij-instrument" search_filter_id="238" columns="3" paginate="true"]');
...
<div class="products-cards products-cards-column">
	<?php
	endif;
